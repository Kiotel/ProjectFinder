...
import com.example.compose.onSecondPrimaryContainerDark
import com.example.compose.onSecondPrimaryContainerDarkHighContrast
import com.example.compose.onSecondPrimaryContainerDarkMediumContrast
import com.example.compose.onSecondPrimaryContainerLight
import com.example.compose.onSecondPrimaryContainerLightHighContrast
import com.example.compose.onSecondPrimaryContainerLightMediumContrast
import com.example.compose.onSecondPrimaryDark
import com.example.compose.onSecondPrimaryDarkHighContrast
import com.example.compose.onSecondPrimaryDarkMediumContrast
import com.example.compose.onSecondPrimaryLight
import com.example.compose.onSecondPrimaryLightHighContrast
import com.example.compose.onSecondPrimaryLightMediumContrast
...
import com.example.compose.secondPrimaryContainerDark
import com.example.compose.secondPrimaryContainerDarkHighContrast
import com.example.compose.secondPrimaryContainerDarkMediumContrast
import com.example.compose.secondPrimaryContainerLight
import com.example.compose.secondPrimaryContainerLightHighContrast
import com.example.compose.secondPrimaryContainerLightMediumContrast
import com.example.compose.secondPrimaryDark
import com.example.compose.secondPrimaryDarkHighContrast
import com.example.compose.secondPrimaryDarkMediumContrast
import com.example.compose.secondPrimaryLight
import com.example.compose.secondPrimaryLightHighContrast
import com.example.compose.secondPrimaryLightMediumContrast
...
val unspecified_extended_scheme = ExtendedColorScheme(
    secondPrimary = unspecified_scheme
)

// Local for accessing extended colors in composables
val LocalExtendedColorScheme = staticCompositionLocalOf { unspecified_extended_scheme }
// endregion

// region Light Schemes
private val lightScheme = expressiveLightColorScheme().copy(
...
// region Extended Color Scheme Instances
val extendedLight = ExtendedColorScheme(
    secondPrimary = ColorFamily(
        secondPrimaryLight,
        onSecondPrimaryLight,
        secondPrimaryContainerLight,
        onSecondPrimaryContainerLight,
    ),
)
...
val extendedDark = ExtendedColorScheme(
    secondPrimary = ColorFamily(
        secondPrimaryDark,
        onSecondPrimaryDark,
        secondPrimaryContainerDark,
        onSecondPrimaryContainerDark,
    ),
)

val extendedLightMediumContrast = ExtendedColorScheme(
    secondPrimary = ColorFamily(
        secondPrimaryLightMediumContrast,
        onSecondPrimaryLightMediumContrast,
        secondPrimaryContainerLightMediumContrast,
        onSecondPrimaryContainerLightMediumContrast,
    ),
)

val extendedLightHighContrast = ExtendedColorScheme(
    secondPrimary = ColorFamily(
        secondPrimaryLightHighContrast,
        onSecondPrimaryLightHighContrast,
        secondPrimaryContainerLightHighContrast,
        onSecondPrimaryContainerLightHighContrast,
    ),
)

val extendedDarkMediumContrast = ExtendedColorScheme(
    secondPrimary = ColorFamily(
        secondPrimaryDarkMediumContrast,
        onSecondPrimaryDarkMediumContrast,
        secondPrimaryContainerDarkMediumContrast,
        onSecondPrimaryContainerDarkMediumContrast,
    ),
)

val extendedDarkHighContrast = ExtendedColorScheme(
    secondPrimary = ColorFamily(
        secondPrimaryDarkHighContrast,
        onSecondPrimaryDarkHighContrast,
        secondPrimaryContainerDarkHighContrast,
        onSecondPrimaryContainerDarkHighContrast,
    ),
)
